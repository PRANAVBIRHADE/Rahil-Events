  ...
  return (
    <section id="schedule" className="py-24 bg-surface relative overflow-hidden">
      <div className="max-w-[1440px] mx-auto px-6 relative z-10">
        <div className="mb-16">
          <h2 className="text-5xl md:text-7xl font-black uppercase italic mb-4 tracking-tighter">Timeline <span className="text-primary-container">3D</span></h2>
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          {/* Left: 3D Selector */}
          <div className="w-full lg:w-1/3 flex flex-row lg:flex-col gap-8 justify-center items-center py-12" style={{ perspective: '1000px' }}>
            {[1, 2].map((day) => (
              <motion.div
                key={day}
                ...
                className={`
                  ...
                  ${activeDay === day ? 'bg-primary-container text-on-primary-container hard-shadow-gold' : 'bg-surface text-on-surface hover:bg-surface-container-low'}
                `}
              ...
              >
                ...
                {/* 3D Sides */}
                <div className="absolute right-[-10px] top-[10px] w-[10px] h-full bg-on-surface/20 origin-left" style={{ transform: 'rotateY(90deg)' }} />
                <div className="absolute bottom-[-10px] left-[10px] w-full h-[10px] bg-on-surface/10 origin-top" style={{ transform: 'rotateX(-90deg)' }} />
              </motion.div>
            ))}
          </div>
