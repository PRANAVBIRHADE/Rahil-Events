...
// Use dynamic import to prevent SSR for the scanner component
  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-12">
      <div className="mb-8 flex justify-between items-end">
        ...
        <Link href="/admin/dashboard" className="border-b-2 border-on-surface font-black uppercase text-[10px] hover:text-primary hover:border-primary transition-colors">
          &larr; Abort Terminal
        </Link>
      </div>
